 ...
 * @hidden
 */
export class FilterExpression extends Base {
    constructor() {
        super(...arguments);
        this.ay = false;
        this.az = false;
 ...
 * @hidden
 */
export class OperationFilterExpression extends FilterExpression {
    constructor(a, b, c) {
        super();
        this.a6 = null;
        this.a8 = false;
 ...
 * @hidden
 */
export class FunctionFilterExpression extends FilterExpression {
    constructor(a, ...b) {
        super();
        this.a6 = 19;
        this.a5 = new FilterExpressionCollection();
        this.a6 = a;
 ...
 * @hidden
 */
export class PropertyReferenceFilterExpression extends FilterExpression {
    constructor(a) {
        super();
        this.a5 = null;
        this.a5 = a;
 ...
 * @hidden
 */
export class LiteralFilterExpression extends FilterExpression {
    constructor(a, b) {
        super();
        this.a6 = null;
        this.a5 = false;
