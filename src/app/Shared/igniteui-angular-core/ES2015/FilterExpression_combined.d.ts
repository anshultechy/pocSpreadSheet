...
export declare abstract class FilterExpression extends Base implements IFilterExpression {
    ...
    a3(a: any, b: IDataSourceDataProvider, c: IDataSourceSchema): boolean;
    private a0;
    ...
    cast(a: IFilterExpression | string): FilterExpression;
}
/**
 * @hidden
 */
