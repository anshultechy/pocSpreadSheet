...
var IgxTooltipContainerDynamicModule = /** @class */ (function () {
    function IgxTooltipContainerDynamicModule() {
        IgxTooltipContainerComponent.register();
    }
    IgxTooltipContainerDynamicModule = tslib_1.__decorate([
        NgModule({
    ...
    ], IgxTooltipContainerDynamicModule);
    return IgxTooltipContainerDynamicModule;
}());
export { IgxTooltipContainerDynamicModule };
//# sourceMappingURL=igx-tooltip-container-dynamic-module.js.map