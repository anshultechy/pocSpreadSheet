 ...
 * @hidden
 */
var DataChartStackedSeriesDescriptionModule = /** @class */ (function (_super) {
    tslib_1.__extends(DataChartStackedSeriesDescriptionModule, _super);
    function DataChartStackedSeriesDescriptionModule() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DataChartStackedSeriesDescriptionModule.register = function (a) {
    ...
    return DataChartStackedSeriesDescriptionModule;
}(Base));
export { DataChartStackedSeriesDescriptionModule };
