 ...
 * @hidden
 */
var DataChartCategorySeriesDescriptionModule = /** @class */ (function (_super) {
    tslib_1.__extends(DataChartCategorySeriesDescriptionModule, _super);
    function DataChartCategorySeriesDescriptionModule() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DataChartCategorySeriesDescriptionModule.register = function (a) {
    ...
    return DataChartCategorySeriesDescriptionModule;
}(Base));
export { DataChartCategorySeriesDescriptionModule };
