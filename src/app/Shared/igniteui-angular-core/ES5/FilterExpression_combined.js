...
import { Base, typeCast, typeGetValue, markType, IComparable_$type, String_$type, Number_$type, Boolean_$type, Date_$type, getInstanceType } from "./type";
...
var FilterExpression = /** @class */ (function (_super) {
    ...
    FilterExpression.prototype.a4 = function () {
        this.ay = this.a2();
    };
    ...
    FilterExpression.prototype.match = function (a, b, c) {
        ...
        return this.a3(d, b, c);
    };
    FilterExpression.prototype.a3 = function (a, b, c) {
        if (!this.ay) {
    ...
    FilterExpression.prototype.length = function () {
        return FilterExpression.func(3, this);
    };
    ...
    FilterExpression.prototype.cast = function (a) {
        if (FilterExpression.isFilterExpression(a)) {
            ...
            var c = a;
            return FilterExpression.func(24, this, FilterExpression.literal(c));
        }
    };
 ...
 * @hidden
 */
var OperationFilterExpression = /** @class */ (function (_super) {
    ...
    OperationFilterExpression.prototype.a2 = function () {
        return this.bf;
    };
    ...
    Object.defineProperty(OperationFilterExpression.prototype, "propertyName", {
        get: function () {
            if (this.a6 == null || !this.a6.isPropertyReference) {
                return null;
            }
            return this.a6.propertyReference;
        },
        set: function (a) {
    ...
    Object.defineProperty(OperationFilterExpression.prototype, "hasPropertyName", {
        get: function () {
            return this.a6 != null && this.a6.isPropertyReference;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(OperationFilterExpression.prototype, "value", {
        get: function () {
            ...
            if (!this.a7.isLiteral) {
                return null;
            }
            return this.a7.literalValue;
        },
        set: function (a) {
            if (a == null) {
    ...
    Object.defineProperty(OperationFilterExpression.prototype, "bf", {
        get: function () {
    ...
    OperationFilterExpression.prototype.bh = function (a, b, c) {
        var d = null;
        var e = null;
        if (this.left != null) {
            d = this.left.evaluate(a, b, c);
 ...
 * @hidden
 */
var FunctionFilterExpression = /** @class */ (function (_super) {
    ...
    function FunctionFilterExpression(a) {
        ...
        var _this = _super.call(this) || this;
        _this.a6 = 19;
        _this.a5 = new FilterExpressionCollection();
        _this.a6 = a;
    ...
    FunctionFilterExpression.prototype.a2 = function () {
        return this.a7;
    };
    ...
    Object.defineProperty(FunctionFilterExpression.prototype, "a7", {
        get: function () {
    ...
    FunctionFilterExpression.prototype.evaluate = function (a, b, c) {
        ...
        switch (this.functionType) {
            ...
            case 24:
                ...
                if (!m.isAssignableFrom(getInstanceType(n))) {
                    return null;
                }
                return this.a8(n, m);
            case 10:
    ...
    FunctionFilterExpression.prototype.a8 = function (a, b) {
        if (b == String_$type) {
            if (a == null) {
                return "";
            }
    ...
    FunctionFilterExpression.prototype.ba = function (a, b) {
    ...
    FunctionFilterExpression.prototype.a9 = function (a) {
        switch (a) {
            case "Edm.Boolean":
            case "Boolean":
            case "bool":
 ...
 * @hidden
 */
var PropertyReferenceFilterExpression = /** @class */ (function (_super) {
    ...
    PropertyReferenceFilterExpression.prototype.a2 = function () {
        return false;
    };
 ...
 * @hidden
 */
var LiteralFilterExpression = /** @class */ (function (_super) {
    ...
    LiteralFilterExpression.prototype.a2 = function () {
