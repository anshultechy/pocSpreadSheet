...
*/
var ExcelLocaleFr = /** @class */ (function () {
    function ExcelLocaleFr() {
        this["DefaultTotalLabel"] = "Total";
        this["Error_AnchoredReference"] = "Tentative d'accéder à {0} en tant que référence sans ancrage";
        this["Error_ExplicitThis"] = "{0} - Explicit This non pris en charge";
        this["Error_ExternalRange"] = "La plage contient une External Reference";
        this["Error_FormulaNotSupported"] = "{0} - Tentative d'accéder à la formule sur une référence ne prenant pas en charge les formules";
        this["Error_Internal"] = "Une erreur interne s'est produite dans la méthode {0}.";
        this["Error_InvalidFunction"] = "Fonction invalide '{0}' à {1}.";
        this["Error_InvalidFunctionArgCountTooFew"] = "La fonction '{0}' référencée à {1} ne contient pas le nombre correct d'arguments. La fonction requiert un minimum de {2} paramètre(s).";
        this["Error_InvalidFunctionArgCountTooMany"] = "La fonction '{0}' référencée à {1} ne contient pas le nombre correct d'arguments. Le nombre d'arguments ne doit pas excéder {2} paramètre(s).";
        this["Error_InvalidNumberSystemDigit"] = "Chiffre invalide de '{0}' rencontré dans la valeur '{1}' pour le système numérique avec la base de {2}.";
        this["Error_InvalidOperand"] = "Opérande invalide";
        this["Error_InvalidOperatorArgCount"] = "La fonction '{0}' doit accepter {1} arguments.";
        this["Error_InvalidReference"] = "Référence invalide ou indisponible";
        this["Error_Location"] = "ligne {0} col {1}";
        this["Error_MethodNotSupported"] = "{0} ne prend pas en charge {1}.";
        this["Error_NoCurrentRangeElement"] = "Aucun Range Element actuel";
        this["Error_NullFunctionResult"] = "L'évaluation de '{0}' a retourné une valeur nulle.";
        this["Error_NullOperand"] = "Opérande nul";
        this["Error_ParseRef"] = "Référence inconnue à {0}.";
        this["Error_RangeFromLast"] = "fromT.Last non défini";
        this["Error_RangeFromNull"] = "RefRange: de est nul";
        this["Error_RangeFromRefBase"] = "RefRange: de n'est pas une RefBase : {0}";
        this["Error_RangeLast"] = "RefRange Validate: derniers nuplets [{0}] != [{1}]";
        this["Error_RangeNormalizeScope"] = "RefRange Normalize: mauvaise étendue [{0}/{1}]";
        this["Error_RangeToNull"] = "RefRange: à est nul";
        this["Error_RangeToRefBase"] = "RefRange: à n'est pas une RefBase : {0}";
        this["Error_RangeTuple"] = "RefRange Validate: nuplets [{0}] != [{1}]";
        this["Error_RangeValidateCount"] = "RefRange Validate: de nombre {0} != à nombre {1}";
        this["Error_ReadOnlyReference"] = "{0} - Tentative de définir la valeur sur une référence en lecture seule";
        this["Error_ReferenceNotEumerable"] = "{0} n'est pas une référence dénombrable";
        this["Error_RefMalformed"] = "{0} - Malformed Reference  {1}";
        this["Error_RP_ContainsBase"] = "RefParser.Contains - base vide";
        this["Error_RP_ContainsTarget"] = "RefParser.Contains - cible vide";
        this["Error_RP_EmptyElement"] = "Référence invalide {0}. Elément vide trouvé à l'emplacement {1}.";
        this["Error_RP_EmptyReference"] = "Référence invalide {0}. La référence est vide.";
        this["Error_RP_MalformedExtra"] = "RefParser Malformed Reference: Plusieurs [{0}] trouvés dans [{1}]";
        this["Error_RP_MalformedUnexpected"] = "RefParser Malformed Reference: [{0}] inattendus trouvés dans [{1}]";
        this["Error_RP_MergeRelativeBase"] = "RefParser.Merge : Base est Relative";
        this["Error_RP_MissingCloseParenthesis"] = "Référence invalide {0}. Parenthèse de fermeture manquante.";
        this["Error_RP_MissingEndQuotes"] = "Référence invalide {0}. Guillemets de fermeture manquants.";
        this["Error_RT_Expected"] = "RefTuple : [{0}] attendu dans [{1}]";
        this["Error_RT_InvalidScope"] = "Etendue invalide : {0}.";
        this["Error_RT_InvalidScope_CharactersAfterClosingQuotes"] = "Caractères trouvés après fermeture des guillemets doubles dans l'étendue {0} à l'emplacement {1}.";
        this["Error_RT_InvalidTuple_CharactersAfterScopeEnd"] = "Elément invalide {0}. Caractères trouvés après la fin de l'étendue.";
        this["Error_RT_InvalidTuple_MissingCloseParenthesis"] = "Elément invalide {0}. Parenthèse de fermeture manquante.";
        this["Error_RT_InvalidTuple_MissingEndQuotes"] = "Elément invalide {0}. Guillemets de fermeture manquants.";
        this["Error_RT_InvalidTuple_NamePortionEmpty"] = "Elément invalide {0}. Partie du nom de l'élément vide.";
        this["Error_RT_InvalidTuple_ScopeIndexLarge"] = "Elément invalide {0}. Index {1} invalide : {2}.";
        this["Error_RT_InvalidTuple_UnescapedCharacter"] = "Caractère {0} non échappé trouvé dans {1} à l'emplacement {2}.";
        this["Error_RT_NullRefName"] = "RefTuple : RefName nul";
        this["Error_RT_Unexpected"] = "RefTuple : [{0}] inattendu dans [{1}]";
        this["Error_ScopeAllNotLast"] = "{0} - Scope All doit apparaître dans le dernier élément {1}";
        this["Error_UCErrorCode_Div"] = "Diviser par zéro";
        this["Error_UCErrorCode_Fail"] = "Echec";
        this["Error_UCErrorCode_NA"] = "Non applicable";
        this["Error_UCErrorCode_Name"] = "Nom invalide";
        this["Error_UCErrorCode_Null"] = "Valeur nulle";
        this["Error_UCErrorCode_Num"] = "Valeurs numériques invalides dans la fonction ou la formule.";
        this["Error_UCErrorCode_Ok"] = "Réussite";
        this["Error_UCErrorCode_Reference"] = "Référence invalide ou indisponible";
        this["Error_UCErrorCode_Unknown"] = "Code invalide";
        this["Error_UCErrorCode_Value"] = "Type incorrect d'argument ou d'opérande.";
        this["Error_UnexpectedScope"] = "{0} - étendue inattendue pour Parent {1}";
        this["Error_UnknownRange"] = "Range Type inconnu";
        this["Error_UnknownRefType"] = "{0} - RefType inconnu {1}";
        this["Error_UnknownScope"] = "{0} - Etendue inconnue {1}";
        this["Error_UnresolvedExternal"] = "Référence externe non résolue";
        this["GenerateTableColumnName"] = "Colonne";
        this["GenerateTableName"] = "Tableau";
        ...
        this["LE_ArgumentException_ColumnNotInTable"] = "La colonne provient d’un tableau différent.";
        ...
        this["LE_ArgumentException_NewRegionOverlapsFilterArea"] = "L’opération tente de changer une plage avec un filtre sur votre feuille de calcul et ne peut pas être terminée. Pour terminer cette opération, les filtres automatiques de la feuille doivent être supprimés.";
        ...
        this["LE_ArgumentException_RegionMustBeOnSameWorksheet"] = "La région doit provenir de la même feuille de calcul.";
        ...
        this["LE_ArgumentOutOfRange_RelativeColumnIndex"] = "L’index relatif de colonne est en dehors de la région spécifiée.";
        this["LE_ArgumentOutOfRange_RelativeRowIndex"] = "L’indice relatif de ligne est en dehors de la région spécifiée.";
        ...
        this["LE_Biff8SerializerNotLoaded"] = "Le format '{0}' requiert un sérialiseur qui n’a pas été chargé, dans JavaScript il est compris dans le fichier infragistics.excel_serialization_biff8.js";
        ...
        this["LE_IconSetInvalid"] = "'IconSetNoIcon' n’est pas un paramètre valide pour la propriété Jeu d’icônes.";
        ...
        this["LE_InvalidOperationException_NoRegionHasBeenSpecified"] = "Aucune région n’a été spécifiée.";
        ...
        this["LE_InvalidValueType"] = "'{0}' n’est pas une valeur valide pour la propriété Type de valeur.";
        ...
        this["LE_NotSingleTargetFormula"] = "Ne peut prendre en charge que des formules cibles uniques.";
        ...
        this["LE_SetValue_Formula"] = "Le type de valeur '{0}' n’est valable que pour les formules. Utiliser la méthode Définir une formule à la place.";
        this["LE_SetValue_NonNumeric"] = "Le paramètre de valeur n’est pas applicable au type de valeur '{0}'. Utiliser la surcharge qui ne prend qu’un type de valeur.";
        this["LE_SetValue_Numeric"] = "Le paramètre de valeur doit être spécifié pour le type de valeur '{0}'. Utiliser la surcharge qui prend à la fois la valeur et le type de valeur.";
        ...
        this["LER_ArgumentOutOfRangeException_OutlineLevel"] = "Le niveau hiérarchique doit être compris entre 0 et 7.";
        this["LER_Exception_KeyNotFound"] = "Clé introuvable.";
        this["LER_Exception_MergedRegionsOverlap"] = "Les régions de cellules fusionnées ne peuvent pas se chevaucher.";
        this["TableHeaderRowDescription"] = "ligne d'en-tête";
        this["TableInsertRowDescription"] = "insérer une ligne";
        this["TableTotalsRowDescription"] = "ligne des totaux";
        ...
        this["WorkbookColorInfo_Automatic_Description"] = "Automatique";
        this["WorkbookColorInfo_Description"] = "ColorInfo: {0}";
        this["WorkbookColorInfo_WithTint_Description"] = "ColorInfo: {0}, Tint: {1}";
        this["WorksheetShapeSerialization_GroupName"] = "Groupe";
        this["WorksheetShapeSerialization_ImageName"] = "Image";
        this["WorksheetShapeSerialization_ShapeName"] = "Forme";
    }
    return ExcelLocaleFr;
}());
export { ExcelLocaleFr };
//# sourceMappingURL=ExcelLocaleFr.js.map