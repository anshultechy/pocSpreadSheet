 ...
 * @hidden
 */
export class SpreadsheetCommandBuilder extends Base {
    constructor() {
        super();
        this.d = null;
        this.f = null;
        this.f = new List$1(CommandMap_KeyMapping.$, 0);
        this.d = new Dictionary$2(Number_$type, CommandMap_Requirement.$, 0);
    }
    n() {
        this.i(8, 4, 1, 0);
        this.i(8, 65536, 139);
    ...
    h(a, b, c, d, ...e) {
        let f = new LongValue(0);
        f.j = a;
        f.i = b;
        let g = new LongValue(0);
        g.j = c;
        g.i = d;
        this.j(f, g, ...e);
    }
    j(a, b, ...c) {
        let d = new CommandMap_Requirement(a, b);
    ...
    m() {
        ...
        let h = 86;
        let i = 87;
        let j = SpreadsheetCommandBuilder.c;
        let k = new LongValue(1, 0, 8);
        let l = new LongValue(1, 0, 1);
        let m = new LongValue(1, 2, 0);
        let n = new LongValue(1, 16, 0);
        let o = new LongValue(1, 32, 0);
        let p = o.e(128);
        let q = new LongValue(1, 512, 0);
        let r = new LongValue(1, 8, 0);
        let s = new LongValue(1, 4194304, 0);
        let t = new LongValue(1, 256, 0);
        let u = new LongValue(1, 4096, 0);
        let v = new LongValue(1, 128, 0);
        let w = v.e(8);
        let x = new LongValue(1, (16 | 128), 0);
        let y = x.d(1);
        let z = new LongValue(1, 512, 1);
        let aa = new LongValue(1, 32, 1);
        let ab = aa.e(1073741824);
        let ac = ab.e(16);
        let ad = ac.e(8);
        let ae = new LongValue(1, 1073741824, 1);
        let af = ae.e(8);
        let ag = ae.e(128);
        let ah = ag.e(8);
        let ai = new LongValue(1, (16 | 1073741824), 1);
        let aj = ai.e(128);
        let ak = aj.e((4194304 | 256));
        let al = aj.e(32);
        let am = al.e(4194304);
        let an = am.e(8);
        let ao = l.e(4194304);
    ...
    static e() {
        let a = new SpreadsheetCommandBuilder();
        a.n();
        return a.d;
    }
    static a() {
