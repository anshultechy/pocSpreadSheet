 ...
 * @hidden
 */
export let SpreadsheetCellRangeBorders_$type = markEnum('SpreadsheetCellRangeBorders', 'LeftBorder,1|TopBorder,2|RightBorder,4|BottomBorder,8|InsideHorizontal,16|InsideVertical,32|DiagonalDown,64|DiagonalUp,128|OutsideBorder,15|InsideBorder,48|AllBorder,63');
