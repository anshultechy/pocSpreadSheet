...
import { WorkbookColorInfo, CellBorderLineStyle, IWorksheetCellFormat, WorksheetCellFormatProxy, WorksheetRow, WorksheetCellFormatData, WorksheetMergedCellsRegion, WorksheetRegionAddress } from "../../igniteui-angular-excel/ES5/excel.core";
/**
 * @hidden
 */
