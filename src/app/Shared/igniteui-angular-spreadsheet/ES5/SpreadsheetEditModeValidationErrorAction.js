 ...
 * @hidden
 */
export var SpreadsheetEditModeValidationErrorAction_$type = markEnum('SpreadsheetEditModeValidationErrorAction', 'ShowPrompt,0|StayInEditMode,1|RevertChange,2|AcceptChange,3');
