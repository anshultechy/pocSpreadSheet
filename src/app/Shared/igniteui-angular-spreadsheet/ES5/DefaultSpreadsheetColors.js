...
import { Base, callStaticConstructors, markType, EnumUtil } from "../../igniteui-angular-core/ES5/type";
 ...
 * @hidden
 */
var DefaultSpreadsheetColors = /** @class */ (function (_super) {
    tslib_1.__extends(DefaultSpreadsheetColors, _super);
    function DefaultSpreadsheetColors() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DefaultSpreadsheetColors.staticInit = function () {
        ...
        var a = EnumUtil.getValues(SpreadsheetResourceId_$type);
    ...
    DefaultSpreadsheetColors.getDefaultColor = function (a) {
        return DefaultSpreadsheetColors.d(a, false);
    };
    DefaultSpreadsheetColors.getDefaultColor2 = function (a) {
        return DefaultSpreadsheetColors.d(a, true);
    };
    DefaultSpreadsheetColors.d = function (a, b) {
        if (b === void 0) { b = false; }
        var c = false == b ? DefaultSpreadsheetColors.a : DefaultSpreadsheetColors.b;
        var d = new Color();
        var e = ((function () { var f = c.tryGetValue(a, d); d = f.p1; return f.ret; })());
        if (e) {
            return d;
        }
    ...
    return DefaultSpreadsheetColors;
}(Base));
export { DefaultSpreadsheetColors };
