...
*/
var UndoLocaleRu = /** @class */ (function () {
    function UndoLocaleRu() {
        this["AddItemDescription"] = "Добавить '{1}'";
        this["AddItemDescriptionDetailed"] = "Добавить '{1}'";
        this["AddRangeDescription"] = "Добавить {1} элемент(-а,-ов) {2}";
        this["AddRangeDescriptionDetailed"] = "Добавить {1} элемент(-а,-ов) {2}";
        ...
        this["MoveItemDescription"] = "Переместить '{1}'";
        this["MoveItemDescriptionDetailed"] = "Переместить '{1}' из '{2}' в '{3}'";
        this["PropertyChangeDescription"] = "Изменить '{0}' в '{1}'";
        this["PropertyChangeDescriptionDetailed"] = "Изменить '{0}' в '{1}' на '{3}'";
        this["ReinitializeCollectionDescription"] = "Пакетное изменение '{2}'";
        this["ReinitializeCollectionDescriptionDetailed"] = "Пакетное изменение '{2}'";
        this["RemoveItemDescription"] = "Удалить '{1}'";
        this["RemoveItemDescriptionDetailed"] = "Удалить '{1}'";
        this["RemoveRangeDescription"] = "Удалить {1} элемент(-а,-ов) {2}";
        this["RemoveRangeDescriptionDetailed"] = "Удалить {1} элемент(-а,-ов) {2}";
        this["ReplaceItemDescription"] = "Заменить '{1}'";
        this["ReplaceItemDescriptionDetailed"] = "Заменить '{1}' на '{2}'";
    }
    return UndoLocaleRu;
}());
export { UndoLocaleRu };
//# sourceMappingURL=UndoLocaleRu.js.map