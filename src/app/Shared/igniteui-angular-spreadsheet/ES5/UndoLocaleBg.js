...
*/
var UndoLocaleBg = /** @class */ (function () {
    function UndoLocaleBg() {
        this["AddItemDescription"] = "Добави '{1}'";
        this["AddItemDescriptionDetailed"] = "Добави '{1}'";
        this["AddRangeDescription"] = "Добави {1} {2}";
        this["AddRangeDescriptionDetailed"] = "Добави {1} {2}";
        ...
        this["MoveItemDescription"] = "Премести '{1}’";
        this["MoveItemDescriptionDetailed"] = "Премести '{1}' от '{2}' на '{3}'";
        this["PropertyChangeDescription"] = "Промени '{0}' на '{1}'";
        this["PropertyChangeDescriptionDetailed"] = "Промени '{0}' на '{1}' на '{3}'";
        this["ReinitializeCollectionDescription"] = "Пакетна промяна на '{2}'";
        this["ReinitializeCollectionDescriptionDetailed"] = "Пакетна промяна на '{2}'";
        this["RemoveItemDescription"] = "Премахни '{1}’";
        this["RemoveItemDescriptionDetailed"] = "Премахни '{1}’";
        this["RemoveRangeDescription"] = "Премахни {1} {2}";
        this["RemoveRangeDescriptionDetailed"] = "Премахни {1} {2}";
        this["ReplaceItemDescription"] = "Замени '{1}’";
        this["ReplaceItemDescriptionDetailed"] = "Замени '{1}’ с '{2}'";
    }
    return UndoLocaleBg;
}());
export { UndoLocaleBg };
//# sourceMappingURL=UndoLocaleBg.js.map