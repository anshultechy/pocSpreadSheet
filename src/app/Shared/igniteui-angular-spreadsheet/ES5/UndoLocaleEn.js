...
*/
var UndoLocaleEn = /** @class */ (function () {
    function UndoLocaleEn() {
        this["AddItemDescription"] = "Add '{1}'";
        this["AddItemDescriptionDetailed"] = "Add '{1}'";
        this["AddRangeDescription"] = "Add {1} {2}(s)";
        this["AddRangeDescriptionDetailed"] = "Add {1} {2}(s)";
        ...
        this["MoveItemDescription"] = "Move '{1}'";
        this["MoveItemDescriptionDetailed"] = "Move '{1}' from '{2}' to '{3}'";
        this["PropertyChangeDescription"] = "Change '{0}' on '{1}'";
        this["PropertyChangeDescriptionDetailed"] = "Change '{0}' on '{1}' to '{3}'";
        this["ReinitializeCollectionDescription"] = "Batch '{2}' Change";
        this["ReinitializeCollectionDescriptionDetailed"] = "Batch '{2}' Change";
        this["RemoveItemDescription"] = "Remove '{1}'";
        this["RemoveItemDescriptionDetailed"] = "Remove '{1}'";
        this["RemoveRangeDescription"] = "Remove {1} {2}(s)";
        this["RemoveRangeDescriptionDetailed"] = "Remove {1} {2}(s)";
        this["ReplaceItemDescription"] = "Replace '{1}'";
        this["ReplaceItemDescriptionDetailed"] = "Replace '{1}' with '{2}'";
    }
    return UndoLocaleEn;
}());
export { UndoLocaleEn };
//# sourceMappingURL=UndoLocaleEn.js.map