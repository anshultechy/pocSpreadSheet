...
import { IWorksheetCellFormat, HorizontalCellAlignment, WorksheetCellFormatData, WorkbookColorInfo, CellBorderLineStyle, DiagonalBorders, CellFill, IWorkbookFont, WorksheetCellFormatOptions, WorkbookStyle, VerticalCellAlignment } from "../../igniteui-angular-excel/ES5/excel.core";
/**
 * @hidden
 */
