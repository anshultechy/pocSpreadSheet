...
*/
var UndoLocaleDe = /** @class */ (function () {
    function UndoLocaleDe() {
        this["AddItemDescription"] = "{1} hinzufügen";
        this["AddItemDescriptionDetailed"] = "{1} hinzufügen";
        this["AddRangeDescription"] = "{1} {2} hinzufügen";
        this["AddRangeDescriptionDetailed"] = "{1} {2} hinzufügen";
        ...
        this["MoveItemDescription"] = "{1} verschieben";
        this["MoveItemDescriptionDetailed"] = "{1} von '{2}' nach '{3}' verschieben";
        this["PropertyChangeDescription"] = "{0} auf {1} ändern";
        this["PropertyChangeDescriptionDetailed"] = "{0} auf {1} in '{2}' ändern";
        this["ReinitializeCollectionDescription"] = "Massenänderung";
        this["ReinitializeCollectionDescriptionDetailed"] = "Massenänderung";
        this["RemoveItemDescription"] = "{1} entfernen";
        this["RemoveItemDescriptionDetailed"] = "{1} entfernen";
        this["RemoveRangeDescription"] = "{1} {2} entfernen";
        this["RemoveRangeDescriptionDetailed"] = "{1} {2} entfernen";
        this["ReplaceItemDescription"] = "{1} ersetzen";
        this["ReplaceItemDescriptionDetailed"] = "'{1}' durch '{2}' ersetzen";
    }
    return UndoLocaleDe;
}());
export { UndoLocaleDe };
//# sourceMappingURL=UndoLocaleDe.js.map