# Ignite UI for Angular Spreadsheet - from Infragistics
...
This package is specifically the spreadsheet components for Ignite UI for Angular.

#### [**View running samples here**](https://www.infragistics.com/products/ignite-ui-angular/angular/components/grid.html)

## NPM Package

You can include Ignite UI for Angular Spreadsheet in your project as a dependency using the NPM package.

`npm install igniteui-angular-spreadsheet --save`
